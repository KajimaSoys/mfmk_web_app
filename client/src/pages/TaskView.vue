...
:root {
 ...
 .system .el-form-item__label, .manufacturer .el-form-item__label, .sup_parameter .el-form-item__label, .system_data .el-form-item__label, .cabinet_parameters .big_text .el-form-item__label, .engine_control .el-form-item__label, .power_inputs .el-form-item__label, .additional .el-form-item__label {
     padding-top: 12px;
     font-size: 1.5vw;
     font-weight: 600;
     color: #6b778c;
